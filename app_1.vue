      ...
      for (let i = 0; i < data.length; i++) {
        ...
        if (typeof data[i].children !== "undefined") {
          ...
          "<br>" +"Adress:" + data[i].adress +"Adress:" + "</a>";
            ...
            html += "<a class='deceased'>"+ "<b>" + data[i].name + " "+ data[i].surname + "</b>" +"<p class='birthdate'>" + data[i].dateofbirth + " -- " + data[i].dateofdeath + "</p>" + "<br>" +"Adress:"  + data[i].adress + "<br>"+ "graveyard adress:" + data[i].graveyard + "</a>"
          }
          if (typeof data[i].wife !== "undefined") {
            if(!data[i].wife.deceased){
            html += "<a class='wife'>" + "<b>" + data[i].wife.name + " "+ data[i].wife.surname + "</b>" +"<p class='birthdate'>" + data[i].wife.dateofbirth + "--" + data[i].wife.dateofdeath  + "</p>" + "<br>" +"Adress:" + data[i].wife.adress + "</a>";
            }
            else{
            html += "<a class='deceasedWife'>" + "<b>" + data[i].wife.name + " " + data[i].wife.surname + "</b>" +"<p class='birthdate'>" + data[i].wife.dateofbirth + " -- " + data[i].wife.dateofdeath + "</p>" + "<br>" +"Adress:" + data[i].wife.adress + "<br>"+ "graveyard adress:" + data[i].wife.graveyard + "</a>";
            }
          }
          ...
          html += "<a>" + "<b>" + data[i].name + " "+ data[i].surname + "</b>" +"<p class='birthdate'>" + data[i].dateofbirth + "--" + data[i].dateofdeath + "</p>" + "<br>" +"Adress:" + data[i].adress +  "</a>";
        }
        else{
          html += "<a class='deceased'>" + "<b>" + data[i].name + " "+ data[i].surname + "</b>" +"<p class='birthdate'>" + data[i].dateofbirth + " -- " + data[i].dateofdeath + "</p>" + "<br>" +"Adress:" + data[i].adress + "<br>" + "graveyard adress:" + data[i].graveyard +  "</a>";
        }
